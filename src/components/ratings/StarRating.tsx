...
function Star({
  ...
  const fillColor = starType === 'full' || starType === 'half' ? color : 'text-gray-300';
  const ariaLabel =
    starType === 'full' ? 'Full Star' : starType === 'half' ? 'Half Star' : 'Empty Star';
  ...
  return (
    <svg
      ...
      viewBox="0 0 24 24"
      fill={starType === 'full' || starType === 'half' ? 'currentColor' : 'none'}
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
